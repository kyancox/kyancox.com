// Code completely from https://github.com/adolfintel/warpspeed/blob/master/react-integration/warpspeed.js
...
(function (root, factory) {
    ...
    function WarpSpeed(targetId,config){
        ...
        this.startTime = timeStamp(); // Add this line to track the start time
    ...
    WarpSpeed.prototype={
        ...
        move:function(){
            ...
            // Add this block to adjust speed over time
            var elapsedTime = (t - this.startTime) / 1000; // elapsed time in seconds
            var initialSpeed = 50; // Initial speed
            var minSpeed = 0.7; // Minimum speed
            var decayRate = 1; // Adjust this value to control the steepness of the drop-off
            this.SPEED = initialSpeed * Math.exp(-decayRate * elapsedTime);
