    ...
    return (
        <section id="projects" className="">
            ...
            <ProjectCard
                ...
                desc="LLM Comparison is a web app that allows you to compare responses from leading Large Language Models (LLMs) like ChatGPT, Gemini, and Claude. Input a prompt, generate responses, and vote for your favorite to see how each model performs."
            ...
            <ProjectCard
                ...
                desc="CoinMerge is a web-app where you can view all of your cryptocurrency assets from Coinbase, Gemini, and Ledger Live in one place. The app utilizes your API keys from your Coinbase and Gemini accounts, as well as a CSV file of your assets from Ledger Live."
