...
const ContactForm = () => {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4 w-11/12 md:w-1/2 my-4">
      ...
      <button
        type="submit"
        className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-background bg-foreground hover:opacity-60 transition duration-200  focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
      >
        Send Message
      </button>
    </form>
